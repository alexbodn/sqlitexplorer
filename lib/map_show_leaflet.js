...
//import * as proj4_exports from "../node_modules/proj4";
//Object.entries(proj4_exports).forEach(([name, exported]) => {window[name] = exported; console.log(name)});
///import * as leaflet_exports from '../node_modules/leaflet/dist/leaflet-src.js';
///Object.entries(leaflet_exports).forEach(([name, exported]) => window[name] = exported);
//import L from "../node_modules/leaflet/dist/leaflet-src.js";
///import * as proj4leaflet from "../node_modules/proj4leaflet/src/proj4leaflet.js";

//import L from "./leaflet-src.js";
///import "./leaflet.sld.js";
//import * as proj4 from "./proj4-src.js";
//.import "./proj4leaflet.js";
///import "./leaflet.zoomdisplay-src.js";
...
class DisplayLeaflet extends DisplayDriver{
	...
	constructor(target='map', currentScript, prefix) {
		super(currentScript, prefix);
...
export {DisplayLeaflet as DisplayDriver};
